...
public class Rocket {
	//global variables
		...
		public Rocket(int initialWidth, int initialHeight) {
			rocket = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("resourcest/blue_bird.png"));
		...
		public BufferedImage getBI() {
			BufferedImage bi = new BufferedImage(rocket.getWidth(null), rocket.getHeight(null), BufferedImage.TYPE_INT_ARGB);
